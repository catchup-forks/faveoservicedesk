...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::post('storage',
        ['as' => 'post.storage', 'uses' => 'App\FaveoStorage\Controllers\SettingsController@postSettings']);
    Route::get('attachment',
        ['as' => 'attach', 'uses' => 'App\FaveoStorage\Controllers\SettingsController@attachment']);
});
