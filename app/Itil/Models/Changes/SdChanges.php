...
class SdChanges extends Model
{
    ...
    public function cab()
    {
        return $this->belongsTo('App\Itil\Models\Common\Cab', 'approval_id');
    }
    ...
    {
        $through = "App\Itil\Models\Changes\ChangeReleaseRelation";
        $firstKey = 'change_id';
    ...
    {
        return $this->belongsTo('App\Itil\Models\Releases\SdLocations', 'location_id');
    }
    ...
    {
        return $this->belongsTo('App\Itil\Models\Changes\SdChangestatus', 'status_id');
    }
    ...
    {
        return $this->belongsTo('App\Itil\Models\Changes\SdChangepriorities', 'priority_id');
    }
    ...
    public function impacts()
    {
        ...
        //dd()
        if ($attr) {
            $attrs = $this->belongsTo('App\Itil\Models\Changes\SdImpacttypes', 'impact_id')->first();
            if ($attrs) {
                $value = $attrs->name;
            }
        }
    ...
    {
        return $this->belongsTo('App\Itil\Models\Changes\SdChangetypes', 'change_type_id');
    }
    ...
    public function release()
    {
        ...
        if ($relation) {
            ...
            $releases = new \App\Itil\Models\Releases\SdReleases();
