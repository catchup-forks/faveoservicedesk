<?php
$sd_release_status = \App\Itil\Models\Releases\SdReleasestatus::lists('name', 'id')->toArray();
$sd_release_priorities = \App\Itil\Models\Releases\SdReleasepriorities::lists('name', 'id')->toArray();
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 {{ $errors->has('plan_start_date') ? 'has-error' : '' }}">
                        ...
                        <label for="inputEmail3"
                               class="control-label">{{Lang::get('itil::lang.planed_start_date')}}</label>
                    ...
                    <div class="form-group col-md-6 {{ $errors->has('plan_end_date') ? 'has-error' : '' }}">
                        <label for="inputEmail3"
                               class="control-label">{{Lang::get('itil::lang.planed_end_date')}}</label>
