            ...
            <div class="pull-right">
                <div class="btn-group">
                    <a href="{{url('service-desk/location-types/'.$location->id.'/edit')}}"
                       class="btn btn-primary">{{Lang::get('itil::lang.edit')}}</a>
                </div>
                <div class="btn-group">
                    <?php
                    $url = url('service-desk/location-types/' . $location->id . '/delete');
                    $delete = \App\Itil\Controllers\UtilityController::deletePopUp($location->id, $url,
                        "Delete $location->name", "btn btn-danger");
                    ?>
                    {!! $delete !!}
                </div>
            </div>
