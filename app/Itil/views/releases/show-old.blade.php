...
@section('content')
    ...
    <section class="content-heading-anchor">
        <h2>
            {{Lang::get('itil::lang.show-release')}}
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h4>
                ...
                <a href="{{url('service-desk/releases/'.$release->id.'/edit')}}"
                   class="btn btn-default">{{Lang::get('itil::lang.edit')}}</a>
            </h4>
            @if (count($errors) > 0)
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table table-condensed">
                        ...
                        <tr>
                            <td>{{Lang::get('itil::lang.planed_start_date')}}</td>
                            <td>
                        ...
                        <tr>
                            <td>{{Lang::get('itil::lang.planed_end_date')}}</td>
                            <td>
                        ...
                        <tr>
                            <td>{{Lang::get('itil::lang.build_plan')}}</td>
                            <td>
                                {!!$release->build_plan!!}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>{{Lang::get('itil::lang.test_plan')}}</td>
                            <td>
                                {!!$release->test_plan!!}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>{{Lang::get('itil::lang.assets')}}</td>
                            <td>
                                {!!$release->getAssets()!!}
                            </td>
                        </tr>
