...
if ($problem->getGeneralByIdentifier('root-cause')) {
    ...
    $delete_root_popup = \App\Itil\Controllers\UtilityController::deletePopUp($popid, $delete_root_url, $title,
        "fa fa-remove", " ");
}
if ($problem->getGeneralByIdentifier('symptoms')) {
    ...
    $delete_symptoms_popup = \App\Itil\Controllers\UtilityController::deletePopUp($popid, $delete_symptoms_url, $title,
        "fa fa-remove", " ");
}
...
if ($problem->getGeneralByIdentifier('solution')) {
    ...
    $delete_solution_popup = \App\Itil\Controllers\UtilityController::deletePopUp($popid, $delete_solution_url, $title,
        "fa fa-remove", " ");
}
if ($problem->getGeneralByIdentifier('impact')) {
    ...
    $title = "Delete impact";
    $delete_impact_popup = \App\Itil\Controllers\UtilityController::deletePopUp($popid, $delete_impact_url, $title,
        "fa fa-remove", " ");
}
?>
<div class="row">
    ...
    <div class="col-md-12">
        ...
        @if($problem->change())
            <!--solution-->
                ...
                <!--/solution-->
            @endif
            @if($problem->attachments()->count()>0)
                <li>
                    <i class="fa fa-paperclip bg-purple" title="attachments"></i>
                    <div class="timeline-item">
                        <div class="timeline-body" style="padding-left:30px;margin-bottom:-20px">
                            <div class="row">
