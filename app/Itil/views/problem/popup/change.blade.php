...
<?php
$statuses = \App\Itil\Models\Changes\SdChangestatus::lists('name', 'id')->toArray();
$sd_changes_priorities = \App\Itil\Models\Changes\SdChangepriorities::lists('name', 'id')->toArray();
$sd_changes_types = App\Itil\Models\Changes\SdChangetypes::lists('name', 'id')->toArray();
$sd_impact_types = \App\Itil\Models\Changes\SdImpacttypes::lists('name', 'id')->toArray();
