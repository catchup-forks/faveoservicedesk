...
@section('content')
    <section class="content-heading-anchor">
        <h2>
            {{Lang::get('service::lang.edit_license_type')}}
    ...
    <div class="box box-primary">
        ...
        <!-- fail message -->
            ...
            @endif
            {!! Form::model($licensetype,['url'=>'service-desk/license-types/'.$licensetype->id,'method'=>'patch','files'=>true]) !!}
        </div><!-- /.box-header -->
        <!-- form start -->
        <div class="box-body">
        ...
        <div class="box box-footer">
            {!! Form::submit(Lang::get('service::lang.update-license-type'),['class'=>'btn btn-success']) !!}
            {!! Form::close() !!}
        </div>
    </div>
