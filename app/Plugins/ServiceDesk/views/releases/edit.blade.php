    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h4>{{str_limit($release->subject,20)}}
                <a href="{{url('service-desk/releases/'.$release->id.'/show')}}"
                   class="btn btn-default">{{Lang::get('service::lang.show')}}</a></h4>
            @if (count($errors) > 0)
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6 {{ $errors->has('plan_start_date') ? 'has-error' : '' }}">
                    ...
                    <label for="inputEmail3"
                           class="control-label">{{Lang::get('service::lang.planed_start_date')}}</label>
                ...
                <div class="form-group col-md-6 {{ $errors->has('plan_end_date') ? 'has-error' : '' }}">
                    <label for="inputEmail3"
                           class="control-label">{{Lang::get('service::lang.planed_end_date')}}</label>
