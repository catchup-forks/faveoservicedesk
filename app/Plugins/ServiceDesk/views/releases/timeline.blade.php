...
if ($release->getGeneralByIdentifier('build-plan')) {
    ...
    $delete_build_popup = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($popid,
...
if ($release->getGeneralByIdentifier('test-plan')) {
    ...
    $delete_test_popup = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($popid,
                            ...
                            <div class="row">
                                <div class="col-md-offset-11">
                                    ...
                                    &nbsp;<a href="#delete" data-toggle="modal"
                                             data-target="#build-plan{{$release->id}}"><i class="fa fa-pencil"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-header">
                            ...
                            <div class="row">
                                <div class="col-md-offset-11">
                                    {!! $delete_test_popup !!}
                                    &nbsp;<a href="#delete" data-toggle="modal"
                                             data-target="#test-plan{{$release->id}}"><i class="fa fa-pencil"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="timeline-body" style="padding-left:30px;margin-bottom:-20px">
