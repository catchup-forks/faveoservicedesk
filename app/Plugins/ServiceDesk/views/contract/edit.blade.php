...
@section('content')
    ...
    <section class="ccontent-heading-anchor">
        <h2>
            {{Lang::get('service::lang.edit_contract')}}
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h4>
                {{ucfirst($contract->name)}}
                <a href="{{url('service-desk/contracts/'.$contract->id.'/show')}}"
        ...
        <!-- fail message -->
            ...
            @endif
            {!! Form::model($contract,['url'=>'service-desk/contracts/'.$contract->id,'method'=>'patch','files'=>true]) !!}
        </div>
        <div class="box-body">
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-success">{{Lang::get('service::lang.edit_contract')}}</button>
                {!! Form::close() !!}
            </div>
