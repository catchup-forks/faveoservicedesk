    ...
    <div class="box box-primary">
        <div class="box-header">
            ...
            <div class="pull-right">
                <div class="btn-group">
                    <a href="{{url('service-desk/contracts/'.$contract->id.'/edit')}}"
                       class="btn btn-primary">{{Lang::get('service::lang.edit')}}</a>
                </div>
                <div class="btn-group">
                    <?php
                    $url = url('service-desk/contracts/' . $contract->id . '/delete');
                    $delete = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($contract->id,
                        $url, "Delete $contract->name", "btn btn-danger");
                    ?>
                    {!! $delete !!}
                </div>
            </div>
