    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h4>
                ...
                <a href="{{url('service-desk/location-types/'.$sd_location->id.'/show')}}"
                   class="btn btn-default">{{Lang::get('service::lang.show')}}</a>
            </h4>
        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            <input type="text" class="form-control" name="title" value="{{$sd_location->title}}"
                                   id="name">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            <input type="text" class="form-control" name="email" value="{{$sd_location->email}}"
                                   id="name">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-6 col-md-6 col-sm-6 col-lg-6 form-group">
                        ...
                        <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                            <input type="text" class="form-control" name="phone" value="{{$sd_location->phone}}"
                                   id="name">
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-6 col-sm-6 col-lg-6 form-group">
                        ...
                        <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                            <input type="text" class="form-control" name="address" value="{{$sd_location->address}}"
                                   id="name">
                        </div>
                    </div>
                </div>
