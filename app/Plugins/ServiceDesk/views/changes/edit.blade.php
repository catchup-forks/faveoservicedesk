...
@section('content')
    ...
    <section class="content-heading-anchor">
        <h2>
            {{Lang::get('service::lang.edit_change')}}
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h4> {{str_limit($change->subject,20)}}
                <a href="{{url('service-desk/changes/'.$change->id.'/show')}}"
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="form-group col-md-6 {{ $errors->has('asset') ? 'has-error' : '' }}">
                    ...
                    {!! Form::select('asset[]',$assets,$change->assets(),['class'=>'form-control','multiple'=>true]) !!}
