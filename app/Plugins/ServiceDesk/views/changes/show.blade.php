        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="{{url('service-desk/changes/'.$change->id.'/edit')}}">{{Lang::get('service::lang.edit')}}</a>
                        </li>
            ...
            <div class="row">
                ...
                <!-- fail message -->
                    ...
                    @if($change->release())
                        ...
                        $detach_pop = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($id,
                            $url, $title, " ", "Deatach " . str_limit($change->release()->subject, 5), false);
                        echo $detach_pop;
                        ...
                        $delete_pop = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($delete_changeid,
