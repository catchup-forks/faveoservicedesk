...
if ($change->getGeneralByIdentifier('reason')) {
    ...
    $title = "Delete reason";
    $delete_reason_popup = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($popid,
        $delete_reason_url, $title, "fa fa-remove", " ");
}
...
if ($change->getGeneralByIdentifier('rollout-plan')) {
    ...
    $delete_rollout_popup = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($popid,
        $delete_rollout_url, $title, "fa fa-remove", " ");
}
if ($change->getGeneralByIdentifier('backout-plan')) {
    ...
    $delete_backout_popup = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($popid,
        $delete_backout_url, $title, "fa fa-remove", " ");
}
?>
<div class="row">
                        ...
                        <div class="timeline-header">
                            ...
                            <div class="row">
                                <div class="col-md-offset-11">
                                    {!! $delete_reason_popup !!}
                                    &nbsp;<a href="#delete" data-toggle="modal" data-target="#reason{{$change->id}}"><i
                            ...
                            <div class="row">
                                <div class="col-md-offset-11">
                                    ...
                                    &nbsp;<a href="#delete" data-toggle="modal"
                                             data-target="#changeimpact{{$change->id}}"><i class="fa fa-pencil"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="timeline-body" style="padding-left:30px;margin-bottom:-20px">
                                    ...
                                    @foreach($change->generalAttachments('impact') as $attachment)
                                        ...
                                        <div class="col-md-3">
                                            <ul class="list-unstyled clearfix mailbox-attachments">
                                                ...
                                                <a href="#delete" data-toggle="modal"
                                                   class="col-md-offset-12 fa fa-remove"
                        ...
                        <div class="timeline-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-offset-11">
                                    ...
                                    &nbsp;<a href="#delete" data-toggle="modal" data-target="#rollout{{$change->id}}"><i
                                                class="fa fa-pencil"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-header">
                            ...
                            <div class="row">
                                <div class="col-md-offset-11">
                                    ...
                                    &nbsp;<a href="#delete" data-toggle="modal" data-target="#backout{{$change->id}}"><i
                                                class="fa fa-pencil"></i></a>
                                </div>
                            </div>
                        </div>
