...
<head>
    ...
    <!-- date picker -->
    <link href="{{asset("http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css")}}"
                ...
                @if($replaceside==0)
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li @yield('email')><a href="{{url('getemail')}}"><i
                                            class="fa fa-at"></i>{!! Lang::get('lang.email') !!}</a></li>
                            ...
                            <li @yield('security')><a href="{{url('security')}}"><i
                                            class="fa fa-hourglass"></i>{!! Lang::get('lang.security') !!}</a></li>
                            <li @yield('status')><a href="{{url('setting-status')}}"><i
                                            class="fa fa-hourglass"></i>{!! Lang::get('lang.status') !!}</a></li>
                            <li @yield('notification')><a href="{{url('settings-notification')}}"><i
                                            class="fa fa-hourglass"></i>{!! Lang::get('lang.notifications') !!}</a></li>
                            <li @yield('ratings')><a href="{{url('getratings')}}"><i
                                            class="fa fa-hourglass"></i>{!! Lang::get('lang.ratings') !!}</a></li>
                            <li @yield('close-workflow')><a href="{{url('close-workflow')}}"><i
                                            class="fa fa-hourglass"></i>{!! Lang::get('lang.close-workflow') !!}</a>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview">
                    ...
                    <li @yield('update')>
                        ...
                        <a href="{!! URL::route('checkupdate') !!}" id="checkUpdate">
                            ...
                            <img id="gif-update" src="{{asset("lb-faveo/media/images/gifloader.gif")}}"
                                 style="width:12%; height:12%; margin-bottom:5%;margin-left:10%;display:none">
...
//
<script src="{{asset("http://ajax.googleapis.com/ajax/libs/jquery/1.5/jquery.min.js")}}"
        type="text/javascript"></script>
//
<script src="{{asset("http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/jquery-ui.min.js")}}"
        type="text/javascript"></script>
