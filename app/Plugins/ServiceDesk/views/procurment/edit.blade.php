...
@section('content')
    <section class="content-heading-anchor">
        <h2>
            {{Lang::get('service::lang.edit-procurement')}}
    ...
    <div class="box box-primary">
        ...
        <!-- fail message -->
            ...
            @endif
            {!! Form::model($procurement,['url'=>'service-desk/procurement/'.$procurement->id,'method'=>'patch','files'=>true]) !!}
        </div><!-- /.box-header -->
        <!-- form start -->
        <div class="box-body">
        ...
        <div class="box box-footer">
            {!! Form::submit(Lang::get('service::lang.update-procurement'),['class'=>'btn btn-success']) !!}
            {!! Form::close() !!}
        </div>
    </div>
