...
@section('content')
    <section class="content-heading-anchor">
        <h2>
            {{Lang::get('service::lang.open_new_procurment')}}
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h4> {{Lang::get('service::lang.open_new_procurment')}}  </h4>
            @if (count($errors) > 0)
        ...
        <!-- fail message -->
            ...
            @endif
            {!! Form::open(['url'=>'service-desk/procurement/create','method'=>'post','files'=>true]) !!}
        </div><!-- /.box-header -->
        <!-- form start -->
        <div class="box-body">
        ...
        <div class="box box-footer">
            {!! Form::submit(Lang::get('service::lang.add-procurement'),['class'=>'btn btn-success']) !!}
            {!! Form::close() !!}
        </div>
    </div>
