...
@section('content')
    <section class="content-heading-anchor">
        <h2>
            {{Lang::get('service::lang.new-vendor')}}
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h4>{{Lang::get('service::lang.new-vendor')}} </h4>
            @if (count($errors) > 0)
        ...
        <!-- fail message -->
            ...
            @endif
            {!! Form::open(['url'=>'service-desk/vendor/create','method'=>'post']) !!}
        </div><!-- /.box-header -->
        <!-- form start -->
        ...
        <div class="box-body">
                ...
                <div class="form-group">
                    <div class="col-xs-11 col-md-11 col-sm-11 col-lg-11">
                        <label for="internal_notes"
                               class="control-label">{{Lang::get('service::lang.description')}}</label>
            ...
            <div class="box-footer">
                ...
                <button type="submit" class="btn btn-success">{{Lang::get('service::lang.add_vendor')}}</button>
