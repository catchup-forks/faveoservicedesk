...
@section('content')
    <section class="content-header">
        <h1> {{Lang::get('service::lang.voting')}} </h1>

    </section>
    <div class="box box-primary">

        <div class="box-header with-border">
            <h4> {{Lang::get('service::lang.mark_your_vote')}} </h4>
            @if (count($errors) > 0)
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="form-group {{ $errors->has('vote') ? 'has-error' : '' }}">
                    <div class="col-md-12">
                        {!! Form::label('vote',Lang::get('service::lang.vote')) !!}
                    </div>
                    <div class="col-md-12">
                ...
                <div class="form-group col-md-12 {{ $errors->has('comment') ? 'has-error' : '' }}">
                    {!! Form::label('comment',Lang::get('service::lang.comment')) !!}
