...
@section('content')
    ...
    <section class="content-heading-anchor" id="heading">
        <h2>
            {{Lang::get('service::lang.new_asset')}}
    ...
    <div class="box box-primary">
        ...
        <div class="box-header with-border">
            <h4>{{Lang::get('service::lang.open_new_asset')}}</h4>
            @if (count($errors) > 0)
        ...
        <div class="box-body">
            ...
            <div class="row">
                {!! Form::open(['url'=>'#','method'=>'','files'=>true,'id'=>'asset-type-form']) !!}
            ...
            <div class="box-footer">
                <div class="from-group">
                    <input type="submit" value="{{Lang::get('service::lang.add_asset')}}" class="btn btn-success"
