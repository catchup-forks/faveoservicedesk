...
if ($problem->getGeneralByIdentifier('root-cause')) {
    ...
    $delete_root_popup = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($popid,
        $delete_root_url, $title, "fa fa-remove", " ");
}
if ($problem->getGeneralByIdentifier('symptoms')) {
    ...
    $delete_symptoms_popup = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($popid,
        $delete_symptoms_url, $title, "fa fa-remove", " ");
}
...
if ($problem->getGeneralByIdentifier('solution')) {
    ...
    $delete_solution_popup = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($popid,
        $delete_solution_url, $title, "fa fa-remove", " ");
}
if ($problem->getGeneralByIdentifier('impact')) {
    ...
    $title = "Delete impact";
    $delete_impact_popup = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($popid,
        $delete_impact_url, $title, "fa fa-remove", " ");
}
?>
<div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-offset-11">
                                    ...
                                    &nbsp;<a href="#delete" data-toggle="modal"
                                             data-target="#rootcause{{$problem->id}}"><i class="fa fa-pencil"></i></a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    @foreach($problem->generalAttachments('root-cause') as $attachment)
                                        ...
                                        <div class="col-md-3">
                                            <ul class="list-unstyled clearfix mailbox-attachments">
                                                <li>
                                                    <a href="{{url('service-desk/download/'.$attachment->id.'/'.$attachment->owner.'/attachment')}}">
                                                        <span class="mailbox-attachment-icon"
                                                              style="background-color:#fff;">{!!strtoupper($attachment->type)!!}</span>
                                                ...
                                                <a href="#change-detach" class="col-md-offset-12 fa fa-remove"
                                                   data-toggle="modal" data-target="#delete{{$deleteid}}"></a>
                                            </ul>
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="timeline-item">
                        <div class="timeline-header">
                            ...
                            <div class="row">
                                <div class="col-md-offset-11">
                                    {!! $delete_impact_popup !!}
                                    &nbsp;<a href="#delete" data-toggle="modal" data-target="#impact{{$problem->id}}"><i
                                ...
                                @foreach($problem->generalAttachments('impact') as $attachment)
                                    ...
                                    <div class="col-md-3">
                                        <ul class="list-unstyled clearfix mailbox-attachments">
                                            ...
                                            <a href="#delete" data-toggle="modal" class="col-md-offset-12 fa fa-remove"
                                               data-target="#delete{{$deleteid}}"></a>
                                        </ul>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="timeline-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-offset-11">
                                    ...
                                    &nbsp;<a href="#delete" data-toggle="modal" data-target="#symptoms{{$problem->id}}"><i
                                                class="fa fa-pencil"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-header">
                            ...
                            <div class="row">
                                <div class="col-md-offset-11">
                                    ...
                                    &nbsp;<a href="#delete" data-toggle="modal" data-target="#solution{{$problem->id}}"><i
                                                class="fa fa-pencil"></i></a>
                                </div>
                            </div>
                        </div>
