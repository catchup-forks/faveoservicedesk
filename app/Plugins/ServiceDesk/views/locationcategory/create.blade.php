...
@section('content')
    <section class="content-heading-anchor">
        <h2>
            {{Lang::get('service::lang.open_new_location_category')}}
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h4> {{Lang::get('service::lang.open_new_location_category')}}  </h4>
            @if (count($errors) > 0)
        ...
        <div class="box box-footer">
            {!! Form::submit(Lang::get('service::lang.add-location-category-types'),['class'=>'btn btn-success']) !!}
            {!! Form::close() !!}
        </div>
    </div>
