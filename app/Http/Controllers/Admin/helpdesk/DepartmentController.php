...
class DepartmentController extends Controller
{
    ...
    public function create(
        User $user,
        Group_assign_department $group_assign_department,
        ...
        try {
            ...
            return view('themes.default1.admin.helpdesk.agent.departments.create',
                compact('department', 'templates', 'slas', 'user', 'emails', 'groups'));
        } catch (Exception $e) {
    ...
    public function edit(
        ...
        try {
            ...
            return view('themes.default1.admin.helpdesk.agent.departments.edit',
                compact('assign', 'team', 'templates', 'departments', 'slas', 'user', 'emails', 'sys_department'));
        } catch (Exception $e) {
    ...
    public function destroy(
        ...
        if ($system->department == $id) {
            ...
            $helptopic = DB::table('help_topic')->where('department', '=', $id)->update(['department' => null],
                ['status' => '1']);
            if ($helptopic > 0) {
            ...
            if ($departments->delete() == true) {
                return redirect('departments')->with('success',
                    Lang::get('lang.department_deleted_sucessfully') . $message);
            } else {
