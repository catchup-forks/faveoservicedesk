        ...
        try {
            switch ($short_name) {
                ...
                case 'mailgun':
                    ...
                    return $form;
                case 'mandrill':
                    $form .= "<div class='row'>" . $this->form('Secret Key', 'secret',
                            'col-md-6 form-group') . '</div>';
                ...
                case 'ses':
                    ...
                    $form .= $this->form('Secret Key', 'secret', 'col-md-6 form-group') . $this->form('Region',
                            'region', 'col-md-6 form-group') . '</div>';
