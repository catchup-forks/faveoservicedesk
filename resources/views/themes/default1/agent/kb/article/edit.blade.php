                ...
                <div class="col-md-4">
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            ...
                            $format = \App\Model\helpdesk\Utility\Date_time_format::where('id',
                                $format)->first()->format;
                            ...
                            <div class="row">
                                ...
                                <span>
                                    ...
                                    <input type="text" name="hour" value="{{$hour}}" style="width: 30px;">:<input
                                            type="text" name="minute" value="{{$minute}}" style="width: 30px;">
                                </span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <a href="#" data-toggle="modal" data-target="#deletearticle{{$article->id}}"
                                       class="btn btn-danger pull-right">{{Lang::get('lang.delete')}}</a>
                                </div>
                                <div class="col-md-4">
                                    <a href="{{url('show/'.$article->slug)}}" target="_blank"
                                       class="btn btn-primary">{{Lang::get('lang.show')}}</a>
                                </div>
                            </div>
                        </div>
            </li>
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-footer" style="background-color:#f5f5f5;">
                            <span class="btn btn-info btn-sm" data-toggle="modal"
                                  data-target="#j">{!! Lang::get('lang.addcategory') !!}</span>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href='{{url("article/delete/$article->slug")}}'>
