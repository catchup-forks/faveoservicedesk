                ...
                @if($replaceside==0)
                    ...
                    <li @yield('inbox')>
                        <a href="{{ url('/ticket/inbox')}}" id="load-inbox">
                            ...
                            <small class="label pull-right bg-green">{{$tickets -> count()}}</small>
                        </a>
                    </li>
                    <li @yield('myticket')>
                    ...
                    @foreach($department as $name=>$dept)
                        ...
                        <li class="treeview @if($dept2 === $name) @yield('ticket-bar') @endif ">
                            <a href="#">
                                <i class="fa fa-folder-open"></i> <span>{!! $name !!}</span> <i
                                ...
                                @if($dept->get($status))
                                    <ul class="treeview-menu">
                                        <li @if($status2 == $dept->get($status)->status && $dept2 === $name) @yield('inbox') @endif>
                                            <a href="{{url('tickets/'.$name.'/'.$dept->get($status)->status)}}"><i
                                                        class="fa fa-circle-o"></i> {!!$dept->get($status)->status !!}
