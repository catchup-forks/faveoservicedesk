...
@section('content')
    ...
    if (Auth::user()->role == 'agent') {
        ...
        $tickets = App\Model\helpdesk\Ticket\Tickets::where('status', '=', 1)->where('assigned_to', '>',
            0)->where('dept_id', '=', $dept->id)->orderBy('id', 'DESC')->count();
    } else {
        $tickets = App\Model\helpdesk\Ticket\Tickets::where('status', '=', 1)->where('assigned_to', '>',
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"> {!! Lang::get('lang.assigned') !!} </h3>
