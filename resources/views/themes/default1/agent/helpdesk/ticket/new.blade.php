                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <!-- helptopic -->
                            <?php $helptopic = App\Model\helpdesk\Manage\Help_topic::where('status', '=',
                                1)->select('topic', 'id')->get(); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <?php $sla_plan = App\Model\helpdesk\Manage\Sla_plan::where('status', '=',
                                1)->select('grace_period', 'id')->get(); ?>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <?php $Priority = App\Model\helpdesk\Ticket\Ticket_Priority::where('status', '=',
                                1)->get(); ?>
