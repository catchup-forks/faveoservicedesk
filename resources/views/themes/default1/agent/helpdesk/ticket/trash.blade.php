...
@section('content')
    ...
    if (Auth::user()->role == 'agent') {
        ...
        $tickets = App\Model\helpdesk\Ticket\Tickets::where('status', '=', 5)->where('dept_id', '=',
            $dept->id)->orderBy('id', 'DESC')->count();
    } else {
    ...
    <div class="box box-warning">
        <div class="box-header with-border">
            <h3 class="box-title">{!! Lang::get('lang.trash') !!} </h3>
        ...
        <input type="submit" class="btn btn-default text-yellow btn-sm" name="submit"  id="close" value="{!! Lang::get('lang.close') !!}">-->
            <div class="btn-group">
                <button type="button" class="btn btn-default dropdown-toggle btn-sm" data-toggle="dropdown" id="d1"><i
                ...
                <ul class="dropdown-menu">
                    <li><input type="submit" class="btn btn-block btn-default btn-sm text-green" id="delete"
                               name="submit" value="{!! Lang::get('lang.open') !!}">
                    </li>
                    <li><input type="submit" class="btn btn-block btn-default btn-sm text-yellow" name="submit"
                               id="close" value="{!! Lang::get('lang.close') !!}"></li>

                </ul>
            </div>
            <input type="submit" class="btn btn-default text-yellow btn-sm" name="submit" id="hard-delete"
                   value="{{Lang::get('lang.clean-up')}}" title="{{Lang::get('lang.trash-delete-title-msg')}}">
