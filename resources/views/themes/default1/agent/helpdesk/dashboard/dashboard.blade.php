    ...
    <div class="row">
            ...
            <a href="{!! route('inbox.ticket') !!}">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"><?php echo $tickets->count() ?>
            ...
            <a href="{!! route('unassigned') !!}">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{$unassigned->count() }}
                            <small> {!! Lang::get('lang.tickets') !!}</small></span>
                    </div><!-- /.info-box-content -->
                </div><!-- /.info-box -->
            </a>
            ...
            <a href="{!! route('overdue.ticket') !!}">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ $overdues->count() }}
            ...
            <a href="{!! route('myticket.ticket') !!}">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{$myticket->count() }}
                            <small> Tickets</small></span>
                    </div><!-- /.info-box-content -->
                </div><!-- /.info-box -->
            </a>
        ...
        <div class="col-md-2" style="width:20%;">
            ...
            if (Auth::user()->role == 'admin') {
                $todaytickets = App\Model\helpdesk\Ticket\Tickets::where('status', '=', 1)->whereDate('tickets.duedate',
                    '=', \Carbon\Carbon::now()->format('Y-m-d'))->count();
            } else {
                $dept = App\Model\helpdesk\Agent\Department::where('id', '=', Auth::user()->primary_dpt)->first();
                $todaytickets = App\Model\helpdesk\Ticket\Tickets::where('status', '=', 1)->whereDate('tickets.duedate',
                    '=', \Carbon\Carbon::now()->format('Y-m-d'))->where('dept_id', '=', $dept->id)->count();
            }
            ?>
