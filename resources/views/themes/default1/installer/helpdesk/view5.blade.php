        ...
        <!-- checking if the system fails -->
            ...
            <div ng-controller="MainController">
                <table>
                    ...
                    <h1 style="border-top:1px solid #dedede; border-bottom:1px solid #dedede; padding: 10px 0px 10px 0px;">
                        Personal Information</h1>
                    <p>Please provide the following information. Don’t worry, you can always change these settings
                        later.</p>
                    <div>
                        <tr>
                            <td>
                            ...
                            <td>
                                <button type="button" data-toggle="popover" data-placement="right"
                                        data-arrowcolor="#eeeeee" data-bordercolor="#bbbbbb"
                                        data-title-backcolor="#cccccc" data-title-bordercolor="#bbbbbb"
                                        data-title-textcolor="#444444" data-content-backcolor="#eeeeee"
                                        data-content-textcolor="#888888" title="@{{Nametitle}}"
                                        data-content="@{{Namecontent}}"
                                        style="padding: 0px;border: 0px; border-radius: 5px;"><i
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" data-toggle="popover" data-placement="right"
                                        ...
                                        data-title-backcolor="#cccccc" data-title-bordercolor="#bbbbbb"
                                        data-title-textcolor="#444444" data-content-backcolor="#eeeeee"
                                        data-content-textcolor="#888888" title="@{{Lasttitle}}"
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" data-toggle="popover" data-placement="right"
                                        ...
                                        data-title-backcolor="#cccccc" data-title-bordercolor="#bbbbbb"
                                        data-title-textcolor="#444444" data-content-backcolor="#eeeeee"
                                        data-content-textcolor="#888888" title="@{{Emailtitle}}"
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" data-toggle="popover" data-placement="right"
                                        ...
                                        data-title-backcolor="#cccccc" data-title-bordercolor="#bbbbbb"
                                        data-title-textcolor="#444444" data-content-backcolor="#eeeeee"
                                        data-content-textcolor="#888888" title="@{{UserNametitle}}"
                                        data-content="@{{UserNamecontent}}"
                                        style="padding: 0px;border: 0px; border-radius: 5px;"><i
                                            class="fa fa-question-circle" style="padding: 0px;"></i>
                                </button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" data-toggle="popover" data-placement="right"
                                        ...
                                        data-title-backcolor="#cccccc" data-title-bordercolor="#bbbbbb"
                                        data-title-textcolor="#444444" data-content-backcolor="#eeeeee"
                                        data-content-textcolor="#888888" title="@{{Passtitle}}"
                                        data-content="@{{Passcontent}}"
                                        style="padding: 0px;border: 0px; border-radius: 5px;"><i
                                            class="fa fa-question-circle" style="padding: 0px;"></i>
                                </button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" data-toggle="popover" data-placement="right"
                                        ...
                                        data-title-backcolor="#cccccc" data-title-bordercolor="#bbbbbb"
                                        data-title-textcolor="#444444" data-content-backcolor="#eeeeee"
                                        data-content-textcolor="#888888" title="@{{Confirmtitle}}"
                    ...
                    <div>
                        <tr>
                            ...
                            <td>
                                <div class="side-by-side clearfix moveleft">
                                    <div>
                                        <select name="datetime" data-placeholder="Choose a date format..."
                            ...
                            <td>
                                <button type="button" data-toggle="popover" data-placement="right"
                                        ...
                                        data-title-backcolor="#cccccc" data-title-bordercolor="#bbbbbb"
                                        data-title-textcolor="#444444" data-content-backcolor="#eeeeee"
                                        data-content-textcolor="#888888" title="@{{Datetimetitle}}"
                                        data-content="@{{Datetimecontent}}"
                                        style="padding: 0px;border: 0px; border-radius: 5px;"><i
                                            class="fa fa-question-circle" style="padding: 0px;"></i>
                                </button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="side-by-side clearfix moveleft">
                                    <div>
                                        <select name="timezone" data-placeholder="Choose a timezone..."
                                                class="chosen-select" style="width:295px;" tabindex="2">
                            ...
                            <td>
                                <button type="button" data-toggle="popover" data-placement="right"
                                        ...
                                        data-title-backcolor="#cccccc" data-title-bordercolor="#bbbbbb"
                                        data-title-textcolor="#444444" data-content-backcolor="#eeeeee"
                                        data-content-textcolor="#888888" title="@{{Timezonetitle}}"
                                        data-content="@{{Timezonecontent}}"
                                        style="padding: 0px;border: 0px; border-radius: 5px;"><i
                                            class="fa fa-question-circle" style="padding: 0px;"></i>
                                </button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="side-by-side clearfix moveleft">
                                    ...
                                    ?>
                                    <select name="language" data-placeholder="Choose a timezone..."
                                            class="chosen-select" style="width:295px;" tabindex="2">
                            ...
                            <td>
                                <button type="button" data-toggle="popover" data-placement="right"
                                        ...
                                        data-title-backcolor="#cccccc" data-title-bordercolor="#bbbbbb"
                                        data-title-textcolor="#444444" data-content-backcolor="#eeeeee"
                                        data-content-textcolor="#888888" title="@{{Languagetitle}}"
                                        data-content="@{{Languagecontent}}"
                                        style="padding: 0px;border: 0px; border-radius: 5px;"><i
                                            class="fa fa-question-circle" style="padding: 0px;"></i>
                                </button>
                            </td>
                ...
                <p class="setup-actions step">
                    <input type="submit" id="submitme" class="button-primary button button-large button-next"
                           value="Install"
                           onclick="this.disabled=true;this.value='Installing, please wait...';this.form.submit();">
