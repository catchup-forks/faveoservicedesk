    ...
    <div class="box box-primary">
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                <button type="button" class="btn btn-default" id="Edit_Ticket" data-toggle="modal" data-target="#Edit">
                    <i class="fa fa-edit" style="color:green;"> </i> Edit
                </button>

                <a href="{{url('ticket/print/'.$tickets->id)}}" target="_blank" class="btn btn-default"><i
                            class="fa fa-print" style="color:blue;"> </i> Print</a>
                <div class="btn-group">
                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" id="d1"><i
                                class="fa fa-exchange" style="color:teal;" id="hidespin"> </i><i
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" id="d2"><i
                                class="fa fa-cogs" style="color:teal;"> </i>
                        More <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu pull-right">

                        <li id="delete"><a href="#"><i class="fa fa-trash-o" style="color:red;"> </i>Delete Ticket</a>
                        </li>
                        <li data-toggle="modal" data-target="#banemail"><a href="#"><i class="fa fa-ban"
                                                                                       style="color:red;"> </i> Ban
                                Email</a></li>
                    </ul>
                </div>
        ...
        <div class="box-body">
            ...
            <div class="row">
                <section class="content">
                    <div class="col-md-12">
                        <?php
                        $priority = App\Model\Ticket\Ticket_Priority::where('priority_id', '=',
                        ...
                        <div class="callout callout-{{$priority->priority_color}}">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <?php $response = App\Model\Ticket\Ticket_Thread::where('ticket_id', '=',
                                        $tickets->id)->get();?>
                    ...
                    <div id="hide2">
                        <div class="col-md-6">
                            <table class="table table-hover" id="refresh">
                                <tr>
                                    <td><b>Status:</b></td>
                                    <div><?php $status = App\Model\Ticket\Ticket_Status::where('id', '=',
                                ...
                                <tr>
                                    <td><b>Priority:</b>
                                    </td> <?php $priority = App\Model\Ticket\Ticket_Priority::where('priority_id', '=',
                                        $tickets->priority_id)->first();?>
                                    <td title="{{$priority->priority_desc}}">{{$priority->priority_desc}}</td>
                                </tr>
                                <tr>
                                    <td><b>Department:</b>
                                    </td> <?php $help_topic = App\Model\Manage\Help_topic::where('id', '=',
                        ...
                        <div class="col-md-6">
                            ...
                            $TicketData = App\Model\Ticket\Ticket_Thread::where('ticket_id', '=',
                                $thread->ticket_id)->max('id');
                            ...
                            if ($tickets->source > 0) {
                                $ticket_source = App\Model\Ticket\Ticket_source::where('id', '=',
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div id="alert22" class="alert alert-warning alert-dismissable" style="display:none;">
                        <button id="dismiss22" type="button" class="close" data-dismiss="alert" aria-hidden="true">×
                        </button>
                        <h4><i class="icon fa fa-warning"></i>Alert!</h4>
                        ...
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-default" data-toggle="modal"
                                    data-target="#{{$tickets->id}}assign"><i class="fa fa-hand-o-right"
                                                                             style="color:orange;"> </i> Assign
                            </button>

                            <button type="button" id="internal" class="btn btn-default"><i class="fa fa-file-text"
                                                                                           style="color:blue;"> </i>
                                Internal Notes
                            </button>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-md-10">
                                            <textarea style="width:98%;height:200px;" name="reply_content"
                                    ...
                                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-md-10">
                                            <button type="submit" class="btn btn-primary"><i
                                                        class="fa fa-check-square-o" style="color:white;"> </i> Update
                                            </button>
                                        </div>
                                    </div>
                                </div>
                ...
                <div id="refresh1">
                    <div class="col-md-12">
                        ...
                        <ul class="timeline">
                            <!-- timeline time label -->
                            <?php
                            $conversations = App\Model\Ticket\Ticket_Thread::where('ticket_id', '=',
                                $tickets->id)->paginate(10);
                            ...
                            <li>
                                ...
                                <?php } }
                                $attachment = App\Model\Ticket\Ticket_attachments::where('thread_id', '=',
                                ...
                                if ($attachment == null) {
                                    ...
                                    $attachments = App\Model\Ticket\Ticket_attachments::where('thread_id', '=',
                                    ...
                                    foreach ($attachments as $attachment) {
                                        ...
                                        if ($attachment->type == 'pdf') {
                                            ...
                                            $body = str_replace($attachment->name,
                                                "data:image/jpg;base64," . base64_encode($data), $body);
                                ...
                                <div class="timeline-item">
                                    <span id="date" class="time" style="color:#fff;"><i
                                                class="fa fa-clock-o"> </i> {{date_format($conversation->created_at, 'd/m/Y H:i:s')}}</span>
                                                ...
                                                if ($attachment->poster == 'ATTACHMENT') {
                                                    if ($attachment->type == 'jpg' || $attachment->type == 'JPG' || $attachment->type == 'jpeg' || $attachment->type == 'JPEG' || $attachment->type == 'png' || $attachment->type == 'PNG' || $attachment->type == 'gif' || $attachment->type == 'GIF') {
                                                        ...
                                                        $var = '<a href="' . URL::route('image',
                                                                array('image_id' => $attachment->id)) . '" target="_blank"><img src="data:image/jpg;base64,' . base64_encode($data) . '"/></a>';
                                                        echo '<li><span class="mailbox-attachment-icon has-img">' . $var . '</span></li>';
                                                    } else {
                                                        $var = '<a href="' . URL::route('image',
                                                                array('image_id' => $attachment->id)) . '" target="_blank">' . $attachment->name . '</a>';
                                                        echo '<li>' . $var . '</li>';
                                                    }
                                                }
                                            }
            ...
            <div class="modal-dialog" style="width:60%;height:70%;">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Edit <b>[#{!! $tickets->ticket_number !!}]</b>[{!! $user->user_name !!}]
                        </h4>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal" id="dismis">Close
                        </button>
                            ...
                            <select name="SelectOwner" class="form-control">
                                @foreach($users as $user)
                                    @if($user->id !== $tickets->user_id)
                                        <option value="{!! $user->user_name !!}">{!! $user->user_name !!}
                                            ({!! $user->email !!})
                                        </option>
                                    @endif
                                @endforeach
        ...
        <div class="modal fade" id="surrender">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal" id="dismis6">
                            Close
                        </button>
