    ...
    <div class="box box-primary">
        ...
        <div class="box-body no-padding">
            <div class="mailbox-controls">
                ...
                <button class="btn btn-default btn-sm" onclick="click()" id="click"><i class="fa fa-refresh"></i>
                </button>
            ...
            <div class=" table-responsive mailbox-messages" id="refresh">
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody id="hello">
                    <?php $tickets = App\Model\Ticket\Tickets::where('status', '=', 1)->orderBy('id',
                        'DESC')->paginate(20);?>
                    ...
                    @foreach ($tickets  as $ticket )
                        <tr <?php if ($ticket->seen_by == null) {?> style="color:green;" <?php }
                            ...
                            <?php $title = App\Model\Ticket\Ticket_Thread::where('ticket_id', '=',
                                $ticket->id)->first();
                            ...
                            <td class="mailbox-name"><a href="{!! URL('myticket',[$ticket->id]) !!}"
                                                        title="{!! $title->title !!}">{{$string}}   </a> ({!! $count!!})
                                <i class="fa fa-comment"></i></td>
                            <td class="mailbox-Id">#{!! $ticket->ticket_number !!}</td>
                            <?php $priority = App\Model\Ticket\Ticket_Priority::where('priority_id', '=',
