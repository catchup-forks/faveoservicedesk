    ...
    <div id="content" class="site-content col-md-12">
        <div id="corewidgetbox">
            <div class="widgetrow text-center">
                ...
                <a href="{{url('auth/register')}}" class="widgetrowitem defaultwidget"
                   style="background-image: URL('lb-faveo/media/images/register.png');">
                ...
                @if($system != null)
                    @if($system->status)
                        ...
                        <a href="{!! URL::route('form') !!}" class="widgetrowitem defaultwidget"
                           style="background-image: URL('lb-faveo/media/images/submitticket.png');">
                ...
                <a href="{{url('mytickets')}}" class="widgetrowitem defaultwidget"
                   style="background-image: URL('lb-faveo/media/images/news.png');">
                ...
                <a href="{{url('/knowledgebase')}}" class="widgetrowitem defaultwidget"
                   style="background-image: URL('lb-faveo/media/images/knowledgebase.png');">
