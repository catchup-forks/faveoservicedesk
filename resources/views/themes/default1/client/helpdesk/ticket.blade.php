        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div id="alert11" class="alert alert-success alert-dismissable" style="display:none;">
                    <button id="dismiss11" type="button" class="close" data-dismiss="alert" aria-hidden="true">×
                    </button>
                    <h4><i class="icon fa fa-check"></i>Alert!</h4>
                    <div id="message-success1"></div>
                </div>
                <div id="alert12" class="alert alert-warning alert-dismissable" style="display:none;">
                    <button id="dismiss12" type="button" class="close" data-dismiss="alert" aria-hidden="true">×
                    </button>
                    <h4><i class="icon fa fa-warning"></i>Alert!</h4>
                    <div id="message-warning1"></div>
                </div>
                <div id="alert13" class="alert alert-danger alert-dismissable" style="display:none;">
                    <button id="dismiss13" type="button" class="close" data-dismiss="alert" aria-hidden="true">×
                    </button>
                                    ...
                                    if ($attachment == null) {
                                        ...
                                        foreach ($attachments as $attachment) {
                                            ...
                                            if ($attachment->type == 'pdf') {
                                                ...
                                                $start = "<head>";
                                                $end = "</head>";
                                                if (strpos($string, $start) == false || strpos($string,
                                                        $start) == false) {
                                                } else {
                                        ...
                                        <div class="timeline-footer" style="margin-bottom:-5px">
                                            ...
                                            <ul class='mailbox-attachments clearfix'>
                                                ...
                                                foreach ($attachments as $attachment) {
                                                    ...
                                                    $value = number_format($size / pow(1024, $power), 2, '.',
                                                            ',') . ' ' . $units[$power];
                ...
                <div class="modal-dialog" style="width:60%;height:70%;">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Edit <b>[#{!! $ticket->ticket_number !!}
                                    ]</b>[{!! $user->user_name !!}]</h4>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="callout callout-info">
                                <i class="icon fa fa-info"> </i>&nbsp;&nbsp;&nbsp; Search existing users or add new
                                users
