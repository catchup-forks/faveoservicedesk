...
@section('content')
                    ...
                    <div class="ticketratings pull-right">
                        <table>
                            ...
                            <form id="foo">
                                <tr>
                                    <th>
                                        <div class="ticketratingtitle">Overall Satisfaction &nbsp;</div>
                                    </th>
                                    &nbsp
                                    <td>
                                        <input type="radio" class="star" id="star5" name="rating"
                                               value="1"<?php echo ($tickets->rating == '1') ? 'checked' : '' ?> />
                                        <input type="radio" class="star" id="star4" name="rating"
                                               value="2"<?php echo ($tickets->rating == '2') ? 'checked' : '' ?> />
                                        <input type="radio" class="star" id="star3" name="rating"
                                               value="3"<?php echo ($tickets->rating == '3') ? 'checked' : '' ?>/>
                                        <input type="radio" class="star" id="star2" name="rating"
                                               value="4"<?php echo ($tickets->rating == '4') ? 'checked' : '' ?>/>
                                        <input type="radio" class="star" id="star1" name="rating"
                                               value="5"<?php echo ($tickets->rating == '5') ? 'checked' : '' ?> />
                                    </td>
                                </tr>
                            </form>
                            </tbody>
    ...
    if ($attachment == null) {
        ...
        $attachments = App\Model\helpdesk\Ticket\Ticket_attachments::where('thread_id', '=',
            $conversation->id)->orderBy('id', 'DESC')->get();
            ...
            <article class="comment-body">
                <footer class="comment-meta"
                    ...
                    <div class="comment-author">
                        @if($role->profile_pic)
                            <img src="{{asset('uploads/profilepic')}}{{'/'}}{{$role->profile_pic}}" alt="" height="50"
                        ...
                        @else
                            <img src="{{ Gravatar::src($role->email) }}" alt="" height="50" width="50" class="avatar"
                                 <?php if($role->role == "user") { ?>style="box-shadow: 0 1px 3px #00FF26;"
                                 <?php } else { ?> style="box-shadow: 0 1px 3px #FFEC00;" <?php } ?> >
                        @endif
                        @if($role->role == "user")
                            ...
                            <div class="ticketratings pull-right">
                                <table>
                                    ...
                                    <form id="foo2">
                                        <tr>
                                            <th>
                                                <div class="ticketratingtitle">Reply rating &nbsp;</div>
                                            </th>
                                            &nbsp
                                            <td>
                                                <input type="radio" class="star" id="star5" name="rating2"
                                                       value="1"<?php echo ($conversation->reply_rating == '1') ? 'checked' : '' ?> />
                                                <input type="radio" class="star" id="star4" name="rating2"
                                                       value="2"<?php echo ($conversation->reply_rating == '2') ? 'checked' : '' ?> />
                                                <input type="radio" class="star" id="star3" name="rating2"
                                                       value="3"<?php echo ($conversation->reply_rating == '3') ? 'checked' : '' ?> />
                                                <input type="radio" class="star" id="star2" name="rating2"
                                                       value="4"<?php echo ($conversation->reply_rating == '4') ? 'checked' : '' ?> />
                                                <input type="radio" class="star" id="star1" name="rating2"
                                                       value="5"<?php echo ($conversation->reply_rating == '5') ? 'checked' : '' ?> />
                                            </td>
                                        </tr>
                                    </form>
                                    </tbody>
