    ...
    <article class=" type-post format-standard hentry clearfix">
        ...
        <div id="comments" class="comments-area">
                        ...
                        <article class="comment-body">
                            <footer class="comment-meta">
                                <div class="comment-author">
                                    <img src="{{asset("lb-faveo/media/images/avatar_1.png")}}" alt="" height="50"
            ...
            <div id="respond" class="comment-respond form-border">
                <h3 id="reply-title"
                    class="comment-reply-title section-title">{!! Lang::get('lang.leave_a_reply') !!}</h3>
                ...
                <div class="row">
                    <div class="form-group">
                        <div class="col-md-4">
                            ...
                            <button type="submit"
                                    class="btn btn-custom btn-lg">{!! Lang::get('lang.post_message') !!}</button>
                        </div>
                        <div class="col-md-8">
