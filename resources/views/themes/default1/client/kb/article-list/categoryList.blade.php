            ...
            @foreach($categorys as $category)
                <div class="col-xs-6">
                    ...
                    <section class="articles-list">
                        <h3><i class="fa fa-folder-open-o fa-fw text-muted"></i> <a
                                    href="{{url('category-list/'.$category->slug)}}">{{$category->name}}</a>
                            ...
                            @forelse($article as $arti)
                                <li class="article-entry image" style="margin-left: 50px;">
                                    ...
                                    <span class="article-meta">{{$arti->created_at->format('l, d-m-Y')}}
                                        ...
                                        <?php $excerpt = App\Http\Controllers\Client\kb\UserController::getExcerpt($str,
                                            $startPos = 0, $maxLength = 55) ?>
                                        <p>{!!$excerpt!!} <a class="readmore-link"
