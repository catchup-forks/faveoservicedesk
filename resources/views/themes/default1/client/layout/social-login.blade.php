...
@if($social->checkActive('google'))
    <a class="btn btn-block btn-social btn-google-plus" href="{{ route('social.login', ['google']) }}"
...
@if($social->checkActive('bitbucket'))
    <a class="btn btn-block btn-social btn-bitbucket" href="{{ route('social.login', ['bitbucket']) }}"
