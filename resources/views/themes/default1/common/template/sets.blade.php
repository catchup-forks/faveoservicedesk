    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                <button class="btn btn-box-tool" data-toggle="modal" data-target="#create" title="Create" id="2create">
                ...
                @foreach($sets as $set)
                    <tr>
                        ...
                        <td>
                            ...
                            ?>
                            @if($set->name == $settings->template)
                                <button class="btn btn-success btn-sm {!! $dis !!}" data-toggle="modal"
                                        data-target="">{!! Lang::get('lang.activate_this_set') !!}</button>
                            @else()
                            ...
                            ?>
                            <button class="btn btn-danger btn-sm {!! $dis !!}" data-toggle="modal"
                                    data-target="#{{$set->id}}delete">{!! Lang::get('lang.delete') !!}</button>
