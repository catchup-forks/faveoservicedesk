                ...
                <div class="box-body no-padding">
                    ...
                    <table class="table table-condensed">
                        ...
                        <tr>
                            ...
                            <td><b>{!! Form::label('company',Lang::get('message.company'),['class'=>'required']) !!}</b>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><b>{!! Form::label('address',Lang::get('message.address'),['class'=>'required']) !!}</b>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group {{ $errors->has('logo') ? 'has-error' : '' }}">
                                    ...
                                    @if($setting->logo)
                                        <img src="{{asset('cart/img/logo/'.$setting->logo)}}" class="img-thumbnail"
                                             style="height: 100px;">
                                    @endif
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><b>{!! Form::label('driver',Lang::get('message.driver'),['class'=>'required']) !!}</b>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><b>{!! Form::label('email',Lang::get('message.email'),['class'=>'required']) !!}</b>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b>{!! Form::label('password',Lang::get('message.password'),['class'=>'required']) !!}</b>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group {{ $errors->has('error_log') ? 'has-error' : '' }}">
                                    ...
                                    {!! Form::radio('error_log','1',true) !!}
                                    <span>   {{Lang::get('message.yes')}}</span>
                        ...
                        <tr>
                            ...
                            <td>
                                <b>{!! Form::label('subscription_going_to_end',Lang::get('message.subscription-going-to-end')) !!}</b>
                            </td>
                            <td>
                                <div class="form-group {{ $errors->has('subscription_going_to_end') ? 'has-error' : '' }}">
                                    ...
                                    <p>
                                        <i> {{Lang::get('message.choose-subscription-going-to-end-notification-email-template')}}</i>
                                    </p>
                        ...
                        <tr>
                            ...
                            <td><b>{!! Form::label('subscription_over',Lang::get('message.subscription-over')) !!}</b>
                            </td>
                            <td>
                                <div class="form-group {{ $errors->has('subscription_over') ? 'has-error' : '' }}">
                                    ...
                                    <p>
                                        <i> {{Lang::get('message.choose-mail-template-to-notify-subscription-has-over')}}</i>
                                    </p>
