                        ...
                        @else
                            <a href="{{url('home')}}" rel="home">
                                ...
                                @if($company->use_logo == 1)
                                    <img src="{{asset('lb-faveo/dist')}}{{'/'}}{{$company->logo}}" alt="User Image"
                                    ...
                                    <li>
                                        <div class="banner-wrapper user-menu text-center clearfix">
                                            ...
                                            <div class="banner-content">
                                                ...
                                                <a href="{{url('auth/logout')}}" class="btn btn-custom btn-xs">Log
                                                    out</a>
                                            </div>
                                        </div>
                                    </li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="site-info col-md-6">
                    <p class="text-muted">Copyright &copy; {!! date('Y') !!} <a
                                href="{!! $company->website !!}">{!! $company->company_name !!}</a>. All rights
                        reserved. Powered by <a href="http://www.faveohelpdesk.com/">Faveo</a></p>
                </div>
            </div>
    </footer><!-- #colophon -->
    <!-- jQuery 2.1.1 -->
