...
<div class="wrapper">
        ...
        <section class="content">
            <div class="callout callout-info">
                ...
                <p>Add the layout-boxed class to the body tag to get this layout. The boxed layout is helpful when
                    working on large screens because it prevents the site from stretching very wide.</p>
            </div>
            <!-- Default box -->
            <div class="box">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-{!! date('Y') !!} <a href="http://almsaeedstudio.com">Almsaeed
                Studio</a>.</strong> All rights reserved.
    </footer>
</div><!-- ./wrapper -->
