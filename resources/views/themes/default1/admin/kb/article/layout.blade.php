...
<div class="wrapper" id="RefreshAssign">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            @else
                                <img src="{{asset('dist')}}{{'/'}}{{Auth::user()->profile_pic}}" class="user-image"
                                     alt="User Image"/>
                            @endif
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                @else
                                    <img src="{{asset('dist')}}{{'/'}}{{Auth::user()->profile_pic}}" class="img-circle"
                                         alt="User Image"/>
                                @endif
                                <p>
                                    {{Auth::user()->name}}
            ...
            <ul class="sidebar-menu">
                <li class="treeview @yield('category')">
                    ...
                    <ul class="treeview-menu">
                        <li @yield('add-category')><a href="{{url('category/create')}}"><i class="fa fa-circle-o"></i>Add
                                Category</a></li>
                        <li @yield('all-category')><a href="{{url('category')}}"><i class="fa fa-circle-o"></i> All
                                Category</a></li>
                    </ul>
                </li>
                <li class="treeview @yield('article')">
                    ...
                    <ul class="treeview-menu">
                        <li @yield('add-article')><a href="{{url('article/create')}}"><i class="fa fa-circle-o"></i>Add
                                Article</a></li>
                        <li @yield('all-article')><a href="{{url('article')}}"><i class="fa fa-circle-o"></i> All
                                Article</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview @yield('pages')">
                    ...
                    <ul class="treeview-menu">
                        <li @yield('add-pages')><a href="{{url('page/create')}}"><i class="fa fa-circle-o"></i>Add Pages</a>
                        </li>
                        <li @yield('all-pages')><a href="{{url('page')}}"><i class="fa fa-circle-o"></i> All Pages</a>
                        </li>
                    </ul>
                </li>
                <li class="treeview @yield('widget')">
                    ...
                    <ul class="treeview-menu">
                        <li @yield('footer1')><a href="{{url('create-footer')}}"><i class="fa fa-circle-o"></i>Footer 1</a>
                        </li>
                        <li @yield('footer2')><a href="{{url('create-footer2')}}"><i class="fa fa-circle-o"></i> Footer
                                2</a></li>
                        <li @yield('footer3')><a href="{{url('create-footer3')}}"><i class="fa fa-circle-o"></i> Footer
                                3</a></li>
                        <li @yield('footer4')><a href="{{url('create-footer4')}}"><i class="fa fa-circle-o"></i> Footer
                                4</a></li>
                        <li @yield('side1')><a href="{{url('side1')}}"><i class="fa fa-circle-o"></i>Side Widget 1</a>
                        </li>
                        <li @yield('side2')><a href="{{url('side2')}}"><i class="fa fa-circle-o"></i>Side Widget 2</a>
                        </li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; {{date("Y")}} <a href="{{$settings->website}}"> {{$settings->company_name}}</a>.
            Powered By <a href="http://www.faveohelpdesk.com">Faveo</a>.</strong>
    </footer>
