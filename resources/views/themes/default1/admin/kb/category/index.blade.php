            ...
            <section class="content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap table table-hover"
                             style="overflow:hidden;">
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="allBlogs" class="table table-bordered table-striped dataTable"
