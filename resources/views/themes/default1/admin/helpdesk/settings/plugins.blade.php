...
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <button type="button" class="btn btn-primary pull-right" id="Edit_Ticket" data-toggle="modal"
                    data-target="#Edit"><b>{!! Lang::get('lang.add_plugin') !!}</b></button>
        ...
        <!-- failure message -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <script src="{{asset('lb-faveo/plugins/jQuery/jQuery-2.1.4.min.js')}}"
                            type="text/javascript"></script>
                    <script type="text/javascript"
                            src="{{asset('lb-faveo/plugins/datatables/jquery.dataTables.js')}}"></script>
                    <script type="text/javascript"
                            src="{{asset('lb-faveo/plugins/datatables/dataTables.bootstrap.js')}}"></script>
