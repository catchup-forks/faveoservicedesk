    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div class="form-group {{ $errors->has('days') ? 'has-error' : '' }}">
                <div class="row">
                    <div class="col-md-3">
                        <label for="title">{!! Lang::get('lang.no_of_days') !!}: <span
                                    class="text-red"> *</span></label>
                    </div>
                    <div class="col-md-9">
                        <div class="callout callout-default"
                             style="font-style: oblique;">{!! Lang::get('lang.close-msg1') !!}</div>
...
{!! Form::radio('condition','0') !!} {{Lang::get('lang.no')}}
            ...
            <div class="form-group {{ $errors->has('send_email') ? 'has-error' : '' }}">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="callout callout-default"
                             style="font-style: oblique;">{!! Lang::get('lang.close-msg4') !!}</div>
                        <div class="row">
                            <div class="col-xs-3">
            ...
            <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="callout callout-default"
                             style="font-style: oblique;">{!! Lang::get('lang.close-msg3') !!}</div>
