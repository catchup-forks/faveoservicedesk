        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group {{ $errors->has('display_order') ? 'has-error' : '' }}">
                    {!! Form::label('display_order',Lang::get('lang.display_order')) !!}<span
            ...
            <div class="form-group {{ $errors->has('rating_scale') ? 'has-error' : '' }}">
                ...
                <div class="callout callout-default"
                     style="font-style: oblique;">{!! Lang::get('lang.rating-msg1') !!}</div>
            ...
            <div class="form-group {{ $errors->has('restrict') ? 'has-error' : '' }}">
                ...
                <div class="callout callout-default"
                     style="font-style: oblique;">{!! Lang::get('lang.rating-msg2') !!}</div>
            ...
            <div class="form-group {{ $errors->has('allow_modification') ? 'has-error' : '' }}">
                <!-- Email user -->
                {!! Form::label('allow_modification',Lang::get('lang.rating_change')) !!}<span
                        style="color:red;">*</span>
                <div class="callout callout-default"
                     style="font-style: oblique;">{!! Lang::get('lang.rating-msg3') !!}</div>
                <div class="row">
                    <div class="col-xs-2">
