                ...
                <!-- failure message -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <a href="{{ url('delete-read-notification') }}"
                                   class="btn btn-danger">{!! Lang::get('lang.del_all_read') !!}</a>
                            </div>
                        </div>
                        <br>
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <form action="{{ url('delete-notification-log') }}" method="post">
                                    <div class="callout callout-default"
                                         style="font-style: oblique;">{!! Lang::get('lang.noti_msg2') !!}</div>
                                    <input type="number" class="form-control" name='no_of_days'
                                           placeholder="{!! lang::get('lang.enter_no_of_days') !!}">
                                    <button type="submit"
                                            class="btn btn-primary">{!! Lang::get('lang.submit') !!}</button>
                                </form>
                            </div>
                        </div>
                    </div>
