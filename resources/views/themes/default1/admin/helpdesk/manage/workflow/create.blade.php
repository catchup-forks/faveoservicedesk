        ...
        <div class="box">
            ...
            <!-- failure message -->
                ...
                <div class="form-group {!! $errors->has('name') ? 'has-error' : '' !!}">
                    <label for="inputName" class="col-sm-2 control-label">{!! Lang::get('lang.name') !!} <span
                ...
                <div class="form-group {!! $errors->has('status') ? 'has-error' : '' !!}">
                    ...
                    <div class="col-sm-6">
                        <input type="radio" id="inputEmail2" name="status" value="1">&nbsp;&nbsp;<label
                                class="control-label" for="inputEmail2">{!! Lang::get('lang.active') !!}</label>&nbsp;&nbsp;
                ...
                <div class="form-group {!! $errors->has('execution_order') ? 'has-error' : '' !!}">
                    <div>
                        <label for="Exceution" class="col-sm-2 control-label">{!! Lang::get('lang.execution_order') !!}
            ...
            <div class="col-xs-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#open" data-toggle="tab">{!! Lang::get('lang.workflow_rules') !!}
                                ...
                                <div>
                                    ...
                                    <div class="box-body">
                                        <table class="table table-bordered table-hover">
                                            <thead>
                                            <tr>
                                                <td>{!! Lang::get('lang.rules') !!} <span class="text-red"> *</span>
                                                </td>
                                                <td>{!! Lang::get('lang.condition') !!} <span class="text-red"> *</span>
                                                </td>
                                                <td>{!! Lang::get('lang.statement') !!} <span class="text-red"> *</span>
                                                </td>
                            ...
                            <div>
                                <div class="box-body">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr id="firstdata1">
                                            <td>
                                                <select class="form-control" onChange="selectdata(0)" id="selected0"
                                                        name="action[0][a]" required>
