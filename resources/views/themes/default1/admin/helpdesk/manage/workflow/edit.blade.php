...
@section('breadcrumbs')
    <ol class="breadcrumb">
        <li><a href="{!! URL::route('setting') !!}"><i class="fa fa-dashboard"></i> {!! Lang::get('lang.home') !!}</a>
        </li>
                ...
                <div class="form-group {!! $errors->has('status') ? 'has-error' : '' !!}">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="radio" id="inputEmail1" name="status" value="0" <?php
                            ...
                            ?> >&nbsp;&nbsp;<label class="control-label"
                                                   for="inputEmail1">{!! Lang::get('lang.inactive') !!}</label>&nbsp;&nbsp;
                    </div>
                </div>
                <div class="form-group {!! $errors->has('execution_order') ? 'has-error' : '' !!}">
                    <div>
                        <label for="Exceution"
                               class="col-sm-2 control-label">{!! Lang::get('lang.execution_order') !!}</label>
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="execution_order" name="execution_order"
                                   placeholder="{!! Lang::get('lang.execution_order') !!}"
                                   value="{!! $workflow->order !!}" required>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xs-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#open"
                                              data-toggle="tab">{!! Lang::get('lang.workflow_rules') !!}</a>
                        </li>
                    ...
                    <div class="tab-content">
                                    ...
                                    <div class="box-body">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            @foreach($workflow_rules as $workflow_rule)
                                                ...
                                                <tr id="firstdata{!! $j !!}">
                                                    <td>
                                                        <select class="form-control" name="rule[{!! $j-1 !!}][a]"
                                                                required>
                                                            <option value="">-- {!! Lang::get('lang.select_one') !!}
                                                                --
                                                            </option>
                                                    ...
                                                    <td class="col-md-3">
                                                        <select class="form-control" name="rule[{!! $j-1 !!}][b]"
                                                                required>
                                                            <option value="">-- {!! Lang::get('lang.select_one') !!}
                                                                --
                                                            </option>
                                ...
                                <div class="box-body">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        @foreach($workflow_actions as $workflow_action)
                                            ...
                                            <tr id="seconddata{!! $i !!}">
                                                <td>
                                                    <select class="form-control" onChange="selectdata({!! $i !!})"
                                                            id="selected{!! $i !!}" name="action[{!! $i !!}][a]"
                                                            required>
                                                        <option value="">-- {!! Lang::get('lang.select_an_action') !!}
                                                            --
                                                        </option>
                                                ...
                                                <td id="fill{!! $i !!}">
                                                    ...
                                                    if ($workflow_action->condition == 'reject') {
                                                        ...
                                                        $sla_plans = App\Model\helpdesk\Manage\Sla_plan::where('status',
                                                            '=', 1)->get();
                                                        $var = "<select name='action[" . $i . "][b]' class='form-control' required>";
                                                        ...
                                                        $teams = App\Model\helpdesk\Agent\Teams::where('status', '=',
                                                            1)->get();
                                                        $var = "<select name='action[" . $i . "][b]' class='form-control' required>";
                                                        ...
                                                        $users = App\User::where('role', '!=', 'user')->where('active',
                                                            '=', 1)->get();
                                                        $var = "<select name='action[" . $i . "][b]' class='form-control' required>";
                                                        ...
                                                        $help_topics = App\Model\helpdesk\Manage\Help_topic::where('status',
                                                            '=', 1)->get();
                                                        $var = "<select name='action[" . $i . "][b]' class='form-control' required>";
                        ...
                        <div class="tab-pane" id="delect">
                            <div>
                                <textarea name="internal_note" class="textarea"
                                          placeholder="Please Enter an internal note for your team!"
