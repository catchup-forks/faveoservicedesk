    ...
    <div class="box box-primary">
        <div class="box-header">
            ...
            <button class="btn btn-primary pull-right" data-toggle="modal"
                    data-target="#createtemp">{{Lang::get('lang.create_template')}}</button>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($directories as $dir)
                    ...
                    <tr>
                        ...
                        <td><a href="{{route('template.list',[$dir,$directory])}}"><?php $parts = explode('.',
                                    $dir); $names = $parts[0]; $name = str_replace('_', ' ',
                                    $names);$name1 = ucfirst($name); echo $name1?></a></td>
                        <!-- template Status : if status==1 active -->
                        <!-- Deleting Fields -->
                        <?php $status = DB::table('settings_email')->first();  ?>
                        <td><input type="radio" disabled="disabled"
                                   value="Active"<?php echo ($status->template == $dir) ? 'checked' : '' ?> /></td>
                        <td>
                            ...
                            <button class="btn btn-danger btn-xs {!! $dis !!}" data-toggle="modal"
                                    data-target="#{{$dir}}delete">Delete
                            </button>
