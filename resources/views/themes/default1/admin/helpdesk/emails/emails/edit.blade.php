...
@section('content')
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-xs-4 form-group {{ $errors->has('email_address') ? 'has-error' : '' }}"
                    ...
                    {!! Form::label('email_address',Lang::get('lang.email_address')) !!} <span
                            class="text-red"> *</span>
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group">
                    ...
                    <input type="checkbox" name="imap_validate"
                           id="imap_validate">&nbsp; {!! Lang::get('lang.validate_certificates_from_tls_or_ssl_server') !!}
                </div>
            </div>
        </div>
        <div class="box-header with-border">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group">
                    ...
                    <input type="checkbox" name="smtp_validate"
                           id="smtp_validate">&nbsp; {!! Lang::get('lang.validate_certificates_from_tls_or_ssl_server') !!}
                </div>
            </div>
            <div id="response"></div>
            <!-- Internal notes -->
        ...
        <div class="box-footer">
            <div class="form-group">
                <input type="checkbox" name="sys_email" @if($sys_email->sys_email == $emails->id) checked
                       @endif @if($count > 1 && $sys_email->sys_email == $emails->id) disabled @endif
                ">&nbsp;&nbsp;{{Lang::get('lang.make-system-default-mail')}}
            </div>
