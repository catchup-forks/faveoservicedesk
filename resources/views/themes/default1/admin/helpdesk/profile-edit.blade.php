        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <div class="content-header">
                    ...
                    <h4>
                        Profile {!! Form::submit(Lang::get('lang.save'),['class'=>'form-group btn btn-primary pull-right'])!!}</h4>
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <div class="content-header">
                    ...
                    <h4>Change
                        Password {!! Form::submit(Lang::get('lang.save'),['class'=>'form-group btn btn-primary pull-right'])!!}</h4>
