...
<div class="col-sm-4 col-md-3 col-lg-2 img-row">
    ...
    <div class="thumbnail thumbnail-img text-center" data-id="{{ $file_name }}" id="img_thumbnail_{{ $key }}">
        @if($type == 'Images')
            <img id="{{ $file_name }}" src="{{ asset($thumb_src) }}" alt="" class="pointer"
