...
{!!Lang::get('lang.verify-screen-msg')!!}
    ...
    <h4 id="loading-screen" class="login-box-msg" style="display:none">
        ...
        <center>Wait we are sending a new OTP code to your number.<br/><img
                    src="{{asset('lb-faveo/media/images/gifloader.gif')}}"></center>
    </h4>
    ...
    <div class="row">
        <div class="col-xs-8">
            ...
            <a id="resend" onclick="resendOTP();" href="#"
               title="{!!Lang::get('lang.resend-otp-title') !!}">{!! Lang::get("lang.resend_otp") !!}</a><br>
        </div><!-- /.col -->
        <div class="col-xs-4">
